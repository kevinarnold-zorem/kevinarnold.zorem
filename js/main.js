...
APP.init = function(){
	...
	this.checkPreloadComplete = function(){
		console.log("Comprobando si está listo");
	...
	APP.unMuteAll = function(ignoreGlobalSoundState){
		console.log("anular el silencio de todo ");
	...
	init: function(){
		...
		$.each($(".vimeo"),function(i,e){
		    ...
		    player.on('loaded', function() {
		        console.log('el video está listo y cargado');
		    });
...
APP.go = function(state, storeHistory){
	...
	console.log("Cambio de estado solicitado. Desde" + this.state + " de " + state);
